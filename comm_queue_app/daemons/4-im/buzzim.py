...
while (min_count<max_count):
     cursor.execute("""select kwippy_buzz.sender_id,kwippy_buzz.receiver_id,kwippy_buzz.message,auth_user.username,kwippy_user_profile.display_name from kwippy_user_profile,kwippy_buzz,auth_user wherekwippy_user_profile.user_id = auth_user.id and  auth_user.id=kwippy_buzz.sender_id and kwippy_buzz.id>=%s and kwippy_buzz.id<%s""",(min_count,min_count+limit,))
     ...
     for c in commands:
          ...
          if acc:
              ...
              if sett[3]=='1':
                  ...
                  mesg = c[4]+" has buzzed you:<br>"+c[2]+"<br><br>Why dont you start kwipping now<br>"+url_prefix
