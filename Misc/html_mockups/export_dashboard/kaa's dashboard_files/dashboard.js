...
var account_list_others = ['11901287','2130495','kwippy_beta@yahoo.com'];
...
<!-- temp hack for IE need to clean this -->
	...
	else if (window.attachEvent)
	{
		...
		$('#buddy')[0].childNodes[3].nodeValue =  ' as a buddy to your ' + account + '.'; 
		$('#buddy')[0].childNodes[10].innerHTML =  'beta@kwippy.com'
  ...
  <!-- temp hack for IE need to clean this -->
	...
	else if (window.attachEvent)
	{
		...
		$('#buddy')[0].childNodes[3].nodeValue =  ' as a buddy to your ' + account + ' messenger.'; 
		$('#buddy')[0].childNodes[10].innerHTML = account_list_others[in_others_list];
