...
function favorite_unfavorite(kwip_id) {
    ...
    if ( (in_ajax != 1)) {
       ...
       $("#favorite_unfavorite_"+kwip_id).load('/kwip/favourite/'+kwip_id+'/' , {kwip_id: kwip_id}, function() {in_ajax = 0;});	
		show_fav_unfav_icons(kwip_id);
	}	
}

function show_fav_unfav_icons(kwip_id){
	if (document.getElementById(kwip_id).childNodes[1].childNodes[0].id[0]=='f')
	{
		document.getElementById('fav_image_'+kwip_id).src='/images/icons/unfavorite.gif'
		document.getElementById('fav_image_'+kwip_id).title='unfavorite this kwip'
		document.getElementById(kwip_id).childNodes[1].childNodes[0].id='unfav_image_'+kwip_id
	}
	else{
		document.getElementById('unfav_image_'+kwip_id).src='/images/icons/favorite.gif'
		document.getElementById('unfav_image_'+kwip_id).title='favorite this kwip'
